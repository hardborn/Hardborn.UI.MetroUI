...
using Hardborn.UI.MetroUI.Windows.Media;
using System;
...
namespace Hardborn.UI.MetroUI.Windows.Navigation
{
    /// <summary>
        ...
        public virtual void Navigate(Uri uri, FrameworkElement source = null, string parameter = null)
        {
            ...
            if (this.commands != null && this.commands.TryGetValue(uri, out command)) {
                ...
                if (source == null) {   // source required
                    throw new ArgumentException(string.Format(CultureInfo.CurrentUICulture, MetroUI.Resources.NavigationFailedSourceNotSpecified, uri));
                }
                ...
                if (frame == null) {
                    throw new ArgumentException(string.Format(CultureInfo.CurrentUICulture, MetroUI.Resources.NavigationFailedFrameNotFound, uri, parameter));
                }
